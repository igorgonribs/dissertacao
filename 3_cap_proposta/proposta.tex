...
As imagens de lâmina inteira bem como as sub-imagens utilizadas neste trabalho estão disponíveis publicamente no endereço: \href{https://github.com/igorgonribs/histology-bone-canals-imageset}{https://github.com/igorgonribs/histology-bone-canals-imageset}.
...
% Se der tempo
% O treinamento também foi realizado com diferentes quantidades de épocas a fim de se validar a possibilidade de super-especialização da rede. As quantidades de épocas testadas foram 50, 100, 500 e 1000.
...
\begin{figure}[h]
    \center
    \includegraphics[width=1.0\textwidth]{figures/3_methods/metodologia.drawio.png}   
