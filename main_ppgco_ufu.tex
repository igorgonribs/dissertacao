...
%	2. Título em inglês
\titulo{Segmentação Automática de Canais Ósseos em Imagens Histológicas Utilizando Redes Neurais Completamente Convolucionais}
